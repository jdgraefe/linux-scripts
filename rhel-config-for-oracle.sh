...
sysctl_conf=$sysctl_check'/sysctl_labs_settings_for_oracle.conf'
limits_conf=$limits_check'/limits_labs_settings_for_oracle.conf' 
...
# GID
gid=$(getent group dba/101 | awk -F ":" '{print $3}')
